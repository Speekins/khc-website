  ...
  return (
    <div id='Services' className='flex items-center justify-between w-screen mt-12 h-screen'>
      <div className='flex bg-services bg-cover w-1/2 h-full max-sm:w-1/4 max-sm:justify-end'>
        <h1 className='p-10 text-white text-9xl font-thin max-xl:text-8xl max-lg:text-7xl max-md:text-6xl max-sm:rotate-90 max-sm:m-24 max-[460px]:m-20 max-[380px]:m-14'>Services</h1>
      </div>
