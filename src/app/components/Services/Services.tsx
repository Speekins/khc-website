...
function Services() {
  return (
    <div id='Services' className='flex items-center justify-between w-screen mt-12 h-[75vh]'>
      ...
      <div className='flex items-center justify-center w-1/2 max-sm:w-3/4 max-[500px]:w-2/3'>
        <ul className='text-3xl font-extralight list-disc max-xl:text-2xl max-md:text-xl max-sm:text-lg max-[500px]:text-md'>
